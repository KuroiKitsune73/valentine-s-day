...
#Change draw speed if you wanna

t.speed(9500)
turtle.colormode(255)
turtle.Screen().bgcolor(0, 0, 0)

#Delete the line 21 if you don't want it full screen

turtle.setup(width=0.95, height=0.95, startx=None, starty=None)

#Add or delete range loops if you want less or more lines in heart
...
#You can make in underlined or bold and change font
